...
## Why Docz
Docz is an easy to use documentation generator, which takes advantage of the MDX files which allows seamless use of JSX in markdown documents.
...
## Modules
A list of node modules used in this library:
